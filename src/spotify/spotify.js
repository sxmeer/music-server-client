...
export const redirectUri = "https://music-player-app-dd145.netlify.app/";
export const spotifyLogoutURL = "https://www.spotify.com/logout/";
export const loginTokenURL = "https://music-app-server-aehc.onrender.com/login";
export const refreshTokenURL = "https://music-app-server-aehc.onrender.com/refresh";
